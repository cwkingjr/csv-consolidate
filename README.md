...
My intention for this tool is to create a python CLI app that also uses a GUI window to grab the directory name, consolidate all the CSV files in it, and write the consolidated CSV file to the user's (Documents?) directory.
